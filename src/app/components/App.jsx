                               ...
                               if(localStorage.token){
                                   ...
                                   if(payload.exp < (new Date().getTime() + 1) / 1000){
                                       ...
                                       if ( localStorage.token && localStorage.rol =="2" && localStorage.S3S=="true"){
                                           ...
                                           return <ConnectedMenuV propiedades = {{renderView : "editRegS3Sv2"}} match = {match} />
                                       }else{
                                           return <Redirect to="/ingresar"/> ;
                                       }
                                   }
                               ...
                               if(localStorage.token){
                                   ...
                                   if(payload.exp < (new Date().getTime() + 1) / 1000){
                                       ...
                                       if ( localStorage.token && localStorage.rol =="2" /* && localStorage.S2=="true" */){
                                           ...
                                           storeValidate.dispatch((alertActions.clear()));
                                           return <ConnectedMenuV propiedades = {{renderView : "createRegv2"}} />
                                       }else{
                                           return <Redirect to="/ingresar"/> ;
                                       }
                                   }
                               ...
                               if(localStorage.token){
                                   ...
                                   if(payload.exp < (new Date().getTime() + 1) / 1000){
                                       ...
                                       if ( localStorage.token && localStorage.rol =="2" && localStorage.S3S=="true"){
                                           ...
                                           storeValidate.dispatch(catalogActions.requesTipoDocumentoCatalogo("tipoDocumento"));
                                           storeValidate.dispatch((alertActions.clear()));
                                           return <ConnectedMenuV propiedades = {{renderView : "createRegS3Sv2"}} />
                                       }else{
                                           return <Redirect to="/ingresar"/> ;
                                       }
                                   }
                               ...
                               if(localStorage.token){
                                   ...
                                   if(payload.exp < (new Date().getTime() + 1) / 1000){
                                       ...
                                       if ( localStorage.token && localStorage.rol =="2" && localStorage.S3P=="true"){
                                           ...
                                           storeValidate.dispatch(catalogActions.requestVialidadCatalogo("vialidad"));
                                           storeValidate.dispatch(catalogActions.requesTipoDocumentoCatalogo("tipoDocumento"));
                                           return <ConnectedMenuV propiedades = {{renderView : "createRegS3Pv2"}} />
                                       }else{
                                           return <Redirect to="/ingresar"/> ;
                                       }
                                   }
                               ...
                               if(localStorage.token){
                                   ...
                                   if(payload.exp < (new Date().getTime() + 1) / 1000){
                                       ...
                                       if (localStorage.token && localStorage.rol =="2" && localStorage.S3S=="true") {
                                           ...
                                           storeValidate.dispatch((alertActions.clear()));
                                           return (<ConnectedMenuV propiedades={{renderView: "S3SSchemav2"}}/>)
                                       } else {
                                           return <Redirect to="/ingresar"/>;
                                       }
                                   }
                            ...
                            if(localStorage.token){
                                ...
                                if(payload.exp < (new Date().getTime() + 1) / 1000){
                                    ...
                                    if ( localStorage.token && localStorage.rol =="2" && localStorage.S2=="true"){
                                        ...
                                        storeValidate.dispatch((alertActions.clear()));
                                        return (<ConnectedMenuV propiedades={{renderView: "S2Schemav2"}}/>)
                                    }else{
                                        return <Redirect to="/ingresar"/>;
                                    }
                                }
                            ...
                            if(localStorage.token){
                                ...
                                if(payload.exp < (new Date().getTime() + 1) / 1000){
                                    ...
                                    if ( localStorage.token && localStorage.rol =="2" && localStorage.S2=="true"){
                                        ...
                                        return <ConnectedMenuV propiedades = {{renderView : "editRegS2v2"}} match = {match} />
                                    }else{
                                        return <Redirect to="/ingresar"/> ;
                                    }
                                }
