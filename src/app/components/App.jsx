              ...
              if (localStorage.token) {
                ...
                if (payload.exp < (new Date().getTime() + 1) / 1000) {
                  ...
                  if (
                    ...
                    storeValidate.dispatch(
                      userActions.requestPermisosSistema(),
                    );
                    storeValidate.dispatch(
                    ...
                    return (
                      <ConnectedMenuV
                        propiedades={{ renderView: "createRegv2" }}
                      />
                    );
                  } else {
                    return <Redirect to="/ingresar" />;
                ...
                storeValidate.dispatch(
                  alertActions.error("No se ha iniciado sesión "),
                );
                return <Redirect to="/ingresar" />;
              }
            }}
              ...
              if (localStorage.token) {
                ...
                if (payload.exp < (new Date().getTime() + 1) / 1000) {
                  ...
                  if (
                    ...
                    storeValidate.dispatch(
                      catalogActions.requesTipoDocumentoCatalogo(
                        "tipoDocumento",
                      ),
                    );
                    storeValidate.dispatch(alertActions.clear());
              ...
              if (localStorage.token) {
                ...
                if (payload.exp < (new Date().getTime() + 1) / 1000) {
                  ...
                  if (
                    ...
                    storeValidate.dispatch(alertActions.clear());
                    storeValidate.dispatch(
                      catalogActions.requestTipoSancionCatalogo(
                        "tipoSancionS3P",
                      ),
                    );
                    storeValidate.dispatch(
              ...
              if (localStorage.token) {
                ...
                if (payload.exp < (new Date().getTime() + 1) / 1000) {
                  ...
                  if (
                    ...
                    return (
                      <ConnectedMenuV
                        propiedades={{ renderView: "S3PSchemav2" }}
                      />
                    );
                  } else {
                    return <Redirect to="/ingresar" />;
              ...
              if (localStorage.token) {
                ...
                if (payload.exp < (new Date().getTime() + 1) / 1000) {
                  ...
                  if (
                    ...
                    return (
                      <ConnectedMenuV
                        propiedades={{ renderView: "S3SSchemav2" }}
                      />
                    );
                  } else {
                    return <Redirect to="/ingresar" />;
              ...
              if (localStorage.token) {
                ...
                if (payload.exp < (new Date().getTime() + 1) / 1000) {
                  ...
                  if (
                    ...
                    return (
                      <ConnectedMenuV
                        propiedades={{ renderView: "S2Schemav2" }}
                      />
                    );
                  } else {
                    return <Redirect to="/ingresar" />;
              ...
              if (localStorage.token) {
                ...
                if (payload.exp < (new Date().getTime() + 1) / 1000) {
                  ...
                  if (
                    ...
                    storeValidate.dispatch(
                      S2Actions.fillRegEdit(match.params.id),
                    );
                    return (
                      <ConnectedMenuV
              ...
              if (localStorage.token) {
                ...
                if (payload.exp < (new Date().getTime() + 1) / 1000) {
                  ...
                  if (
                    ...
                    return (
                      <ConnectedMenuV
                        propiedades={{ renderView: "createReg" }}
                      />
                    );
                  } else {
                    return <Redirect to="/ingresar" />;
              ...
              if (localStorage.token) {
                ...
                if (payload.exp < (new Date().getTime() + 1) / 1000) {
                  ...
                  if (
                    ...
                    return (
                      <ConnectedMenuV
                        propiedades={{ renderView: "S2Schema" }}
                      />
                    );
                  } else {
                    return <Redirect to="/ingresar" />;
              ...
              if (localStorage.token) {
                ...
                if (payload.exp < (new Date().getTime() + 1) / 1000) {
                  ...
                  if (
                    ...
                    return (
                      <ConnectedMenuV
                        propiedades={{ renderView: "editRegS2" }}
                        match={match}
                      />
                    );
                  } else {
              ...
              if (localStorage.token) {
                ...
                if (payload.exp < (new Date().getTime() + 1) / 1000) {
                  ...
                  if (localStorage.token && localStorage.rol == "1") {
                    ...
                    return (
                      <ConnectedMenuV
                        propiedades={{ renderView: "createuser" }}
                      />
                    );
                  } else {
                    return <Redirect to="/ingresar" />;
            ...
            render={() => {
              if (localStorage.token) {
                ...
                if (payload.exp < (new Date().getTime() + 1) / 1000) {
                  ...
                  if (localStorage.token && localStorage.rol == "1") {
                    storeValidate.dispatch(
                      providerActions.requestAllProviders(),
                    );
                    storeValidate.dispatch(
                      userActions.requestPerPage({ page: 1, pageSize: 10 }),
                    );
                    return (
                      <ConnectedMenuV propiedades={{ renderView: "users" }} />
                    );
                  } else {
                    return <Redirect to="/ingresar" />;
                  }
              ...
              if (localStorage.token) {
                ...
                if (payload.exp < (new Date().getTime() + 1) / 1000) {
                  ...
                  if (localStorage.token && localStorage.rol == "1") {
                    ...
                    return (
                      <ConnectedMenuV
                        propiedades={{ renderView: "providers" }}
                      />
                    );
                  } else {
                    return <Redirect to="/ingresar" />;
