...
export const ListS3SSchemav2 = () => {
    ...
    return (
        <>
            ...
            <Dialog fullWidth={true} maxWidth={maxWidth} onClose={handleCloseModalUserInfo}
                ...
                <DialogContent dividers>
                        <Grid container spacing={1}>
                            ...
                            <Grid item md={3} sm={12}>
                                ...
                                <Typography className={classes.body2} align="left" variant="body2">
                                    {selectedRegistro.resolucion ? selectedRegistro.resolucion.url : ""}
                                </Typography>
                            </Grid>
                            ...
                            <Grid item md={12} sm={12}>
                                ...
                                <Typography className={classes.body2} align="left" variant="body2">
                                    {selectedRegistro.observaciones ? selectedRegistro.observaciones : ""}
                                </Typography>
                            </Grid>
                            <Grid item xs={12} >
                                <Divider />
                        ...
                        <Table aria-label="custom pagination table">
                            <TableHead className={classes.tableHead}>
                                <TableRow>
                                    ...
                                    <StyledTableCell className={classes.tableHeaderColumn}><b>Institución</b></StyledTableCell>
                                    <StyledTableCell className={classes.tableHeaderColumn}><b>Servidor público</b></StyledTableCell>
                                    <StyledTableCell className={classes.tableHeaderColumn}><b>Tipo falta</b></StyledTableCell>
                                        ...
                                        <StyledTableCell style={{width: "20%"}} align="center">
                                            ...
                                            <Button style={{padding: '0px'}}
                                                ...
                                                <Tooltip title="Ver registro" placement="top">
                                                    <Button style={{color: "#34b3eb"}} aria-label="expand row"
                                                                size="small">
                                                        <VisibilityIcon/>
                                                    </Button>
                                                </Tooltip>
