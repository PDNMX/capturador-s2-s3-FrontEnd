    ...
    return (
        <div className={classes.root}>
                   ...
                   <Typography component="div" variant="h6" color="#fff" noWrap >
                    ...
                    <div sx={{ justifyContent: "flex-end" }}>
                        <Button aria-controls="simple-menu" aria-haspopup="true" onClick={handleClick}>
                            <ManageAccountsIcon className={classes.colorico} fontSize="large" />
                        </Button>
                        <Menu
                            id="simple-menu"
                            anchorEl={anchorEl}
            ...
            >
                ...
                <List>
                        { (rol=="2") &&
                            <ListItem onClick={e=>menuAdminDatos2(e)} key={'m1'} disablePadding>
                        ...
                        {permisos.map(item => (
                            item==="S2" &&
                                <Collapse in={checkedAdminDatos2} key="S2">
                                    <ListItem onClick={ () => redirectToRoute("/consulta/S2v2")} key={'m1s2v2'} disablePadding>
                        ...
                        {permisos.map(item => (
                            item==="S3S" &&
                                <Collapse in={checkedAdminDatosS3S} key="S3S">
                                    <ListItem onClick={ () => redirectToRoute("/consulta/S3Sv2")} key={'m1s3sv2'} disablePadding>
                                        <ListItemButton sx={{ pl: 3.5 }}>
                                            <ListItemIcon>
                                            <CircleIcon sx={{maxHeight: '8px'}}/>
                                            </ListItemIcon>
                        ...
                        {permisos.map(item => (
                            item==="S2" &&
                                <Collapse in={checkedDatos2} key="S2">
                                    <ListItem onClick={ () => redirectToRoute("/captura/S2v2")} key={'m3s2v2'} disablePadding>
                                        <ListItemButton sx={{ pl: 3.5 }}>
                                            <ListItemIcon>
                                                <CircleIcon sx={{maxHeight: '8px'}}/>
                                            </ListItemIcon>
                        ...
                        {permisos.map(item => (
                            item==="S3S" &&
                                <Collapse in={checkedDatosS3S} key="S3S">
                                        <ListItem onClick={ () => redirectToRoute("/captura/S3Sv2")} key={'m3s3sv2'} disablePadding>
                                            <ListItemButton sx={{ pl: 3.5 }}>
                                                <ListItemIcon>
                                                    <CircleIcon sx={{maxHeight: '8px'}}/>
                                                </ListItemIcon>
                        ...
                        {permisos.map(item => (
                            item==="S3P" &&
                                <Collapse in={checkedDatosS3P} key="S3P">
                                    <ListItem onClick={ () => redirectToRoute("/captura/S3Pv2")} key={'m3s3pv2'} disablePadding>
                                        <ListItemButton sx={{ pl: 3.5 }}>
                                            <ListItemIcon>
                                                <CircleIcon sx={{maxHeight: '8px'}}/>
                                            </ListItemIcon>
                        ...
                        { submenuUsuario &&
                            <Collapse in={checkedUser}>
                                <ListItem onClick={ () => redirectToRoute("/usuario/crear")} key={'mu1'} disablePadding>
                                    <ListItemButton sx={{ pl: 3.5 }}>
                                        <ListItemIcon>
                                            <ControlPointIcon/>
                                        </ListItemIcon>
                                ...
                                <ListItem onClick={ () => redirectToRoute("/usuarios")} key={'mu2'} disablePadding>
                                    <ListItemButton sx={{ pl: 3.5 }}>
                                        <ListItemIcon>
                        ...
                        { rol=="1" &&
                            <ListItem onClick={e=>menuProveedor(e)} key={'mp'} disablePadding>
                                <ListItemButton sx={{ p: 2 }}>
                                    <ListItemIcon>
                        ...
                        { crearProovedor &&
                            <Collapse in={checkedProveedor}>
                                <ListItem onClick={ () => redirectToRoute("/proveedor/crear")} key={'mp1'} disablePadding>
                                    <ListItemButton sx={{ pl: 3.5 }}>
                                        <ListItemIcon>
                                            <ControlPointIcon />
                                        </ListItemIcon>
                                ...
                                <ListItem onClick={ () => redirectToRoute("/proveedores")} key={'mp2'} disablePadding>
                                    <ListItemButton sx={{ pl: 3.5 }}>
                                        <ListItemIcon>
                                            <FormatListBulletedIcon />
                                        </ListItemIcon>
                ...
                <div/>
                <Box component="main" sx={{ flexGrow: 1, backgroundColor: '#EEF2F6', minHeight: "100vh", padding: "15px", }}>
                <Toolbar />
